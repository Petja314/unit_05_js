...
function t6() {
    ...
    let innerb = +document.querySelector('.i-6').value;
    let a = '';
    for (let i = 0; i < innerb; i++) {
        a += '******<br>';
    }
    out.innerHTML = a;
...
function t7() {
    ...
    let a = '';
    let innerb = +document.querySelector('.i-7').value;
    for (i = innerb; i >= 0; i--) {
        a += i + '_';
    }
    out.innerHTML = a;
...
function t8() {
    let v1 = document.querySelector('.i-81').value;
    let v2 = document.querySelector('.i-82').value;
...
function t9() {
    let v1 = +document.querySelector('.i-91').value;
    let v2 = +document.querySelector('.i-92').value;
...
function t12() {
    ...
    for (let i = 0; i < elem.length; i++) {
        o += elem[i].style.background = 'orange';
    }
...
function t13() {
    let v1 = document.querySelectorAll('.i-13');
...
function t14() {
    ...
    let o = '';
    let v1 = document.querySelectorAll('.i-14');
